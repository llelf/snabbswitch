...
function VirtioNetDevice:rx_packet_start(header_id, addr, len)
   ...
   return header_id, header_pointer, total_size, header_len, pack
end
...
function VirtioNetDevice:rx_buffer_add(rx_p, addr, len, rx_total_size, tx)
   ...
   local new_total_size = rx_total_size + b.size
   ...
   packet.add_iovec(rx_p, b, b.size)

   return nil, new_total_size
end

function VirtioNetDevice:rx_packet_end(rx_header_id, rx_header_pointer,
				       rx_total_size, rx_p, buf)
...
function VirtioNetDevice:tx_packet_start(header_id, addr, len)
   ...
   return header_id, tx_header_pointer,
          virtio_net_hdr_size, virtio_net_hdr_size, nil
end

function VirtioNetDevice:tx_buffer_add(rx_p, addr, len, tx_total_size, tx)
